...
export function PageLink({ href, label, description }: PageLinkProps) {
  return (
    <Link
      to={href}
      className="group flex items-center justify-between p-5 rounded-xl bg-background border border-border shadow-sm hover:shadow-md hover:border-primary/30 hover:-translate-y-0.5 transition-all duration-300"
    >
      <div>
